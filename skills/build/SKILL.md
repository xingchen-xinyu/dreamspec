...
1. **加载 PO 角色 Skill（skills/po/SKILL.md）** 中的原型设计规范
2. **加载 QA 角色 Skill（skills/qa/SKILL.md）** 中的原型检查标准
...
1. **加载 TL 角色 Skill（skills/tl/SKILL.md）** 中的工程规范
2. **加载 QA 角色 Skill（skills/qa/SKILL.md）** 中的质量检查标准
