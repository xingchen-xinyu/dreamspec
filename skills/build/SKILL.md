---
name: ds:build
description: 当用户描述功能开发、问题修复、性能优化、代码重构需求时使用
---
...
> 自动触发通过 skill 系统的 description 匹配实现：AI 收到用户消息时，根据本技能 description
> 中的触发条件匹配用户意图，自动调用 Skill 工具加载。不依赖 CLAUDE.md 中的路由规则。
